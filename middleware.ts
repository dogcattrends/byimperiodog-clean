...
export function middleware(req: NextRequest) {
 ...
 // Regra: o PDF do guia so pode ser baixado apos preencher o formulario.
 // Bloqueia acesso direto aos assets publicos e direciona para /guia.
 if (pathname === "/guia.pdf" || pathname === "/guia-v2.pdf") {
  const to = req.nextUrl.clone();
  to.pathname = "/guia";
  to.searchParams.set("token_error", "direct");
