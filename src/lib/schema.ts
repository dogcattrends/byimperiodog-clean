...
export function productSchema(
 ...
 name: puppy.name,
 description:
 "Spitz Alemão Lulu da Pomerânia de porte mini, acompanhamento vitalício e suporte personalizado.",
 brand: {
 "@type": "Brand",
 name: "By Império Dog",
 },
...
export function buildOfferCatalogLD(opts: {
 ...
 name: "Filhotes de Spitz Alemão Anão Lulu da Pomerânia disponíveis",
