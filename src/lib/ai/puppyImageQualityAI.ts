...
async function runVisionCheck(buffer: Buffer, format?: string | null): Promise<VisionResult | null> {
 ...
 role: "system",
 content:
 "Você é um avaliador de imagens de filhotes premium. Analise foco, luz, enquadramento e confirme se é um Spitz Alemão Lulu da Pomerânia. Responda APENAS em JSON.",
 },
 {
 role: "user",
 content: [
