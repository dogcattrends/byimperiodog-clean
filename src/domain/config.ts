...
export const SEO_CONFIG = {
 ...
 defaultDescriptions: {
 puppy:
 "Conheça {name}, filhote de Spitz Alemão Anão Lulu da Pomerânia {color} {sex}. Pedigree, suporte vitalício e entrega segura. By Império Dog - criadora especializada.",
 catalog:
