...
export default defineType({
 ...
 title: 'SEO title',
 type: 'string',
 description: 'Título para SERP (ideal ~50–60 chars). Se vazio, usa o Title.',
 }),
 defineField({
 name: 'seoDescription',
 ...
 type: 'text',
 rows: 3,
 description: 'Descrição para SERP (ideal ~140–160 chars). Se vazio, usa o excerpt.',
 }),
 defineField({
 name: 'canonicalUrl',
 title: 'Canonical URL',
 ...
 description: 'Se definido, substitui o canonical padrão do post.',
 }),
 defineField({
 name: 'robots',
 title: 'Robots',
 type: 'string',
 description: 'Ex.: "index,follow" ou "noindex,nofollow". Se vazio, usa padrão do site.',
 }),
 defineField({
 name: 'ogImageUrl',
 title: 'OG image URL',
 type: 'url',
 validation: (Rule: SanityRule) => Rule.uri({allowRelative: false}).optional(),
 description: 'Se definido, tem prioridade para OpenGraph/Twitter.',
 }),
 defineField({
 name: 'answerSnippet',
