...
const faqSP = [
 ...
 answer:
 "O Spitz Alemão Anão Lulu da Pomerânia tem porte mini e costuma pesar entre 1,5kg e 3,5kg quando adulto. São cães ideais para apartamentos.",
 },
];

export default function FilhotesSaoPauloPage() {
const waLink = buildWhatsAppLink({
 message: "Olá! Gostaria de informações sobre filhotes em São Paulo.",
 utmSource: "site",
 utmMedium: "filhotes-sao-paulo",
