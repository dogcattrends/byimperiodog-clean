...
const CATEGORY_DEFINITIONS: CategoryDefinition[] = [
 ...
 title: "Cuidados",
 description:
 "Nutrição personalizada, higiene estratégica e protocolos preventivos para manter o Spitz Alemão Anão Lulu da Pomerânia saudável e confiante.",
 highlight: "Orientações dos primeiros dias ao primeiro ano, com suporte contínuo.",
 match: (post) => includesCategory(post, ["cuidado", "rotina", "nutri", "higiene"]),
 cta: { label: "Ver primeiros cuidados", href: "/faq-do-tutor#primeiros-cuidados" },
 },
 {
 id: "adestramento",
 title: "Adestramento",
 description:
 "Socialização guiada, enriquecimento ambiental e reforço positivo para lares urbanos com agenda cheia.",
 ...
 title: "Saúde",
 description:
 "Preventivo completo: exames genéticos, cardiológicos e protocolos veterinários para o Spitz Alemão Anão Lulu da Pomerânia.",
 ...
 cta: { label: "Ver FAQ do tutor", href: "/faq-do-tutor#faq-principais" },
 },
 {
 id: "perguntas-frequentes",
 title: "Perguntas Frequentes",
 description:
 "Respostas diretas sobre investimento, logística, convívio com crianças e integração com outros pets.",
 ...
 cta: { label: "FAQ do tutor", href: "/faq-do-tutor#faq-principais" },
 },
];
...
const BLOG_FAQ = [
 ...
 answer: "Claro. O blog foi pensado para famílias e para quem ajuda na decisão, com informações organizadas para consulta rápida.",
 },
];
...
export default async function BlogListPage({ searchParams }: { searchParams?: PageSearchParams }) {
 ...
 <Hero searchTerm={searchTerm} sort={sort} links={HERO_LINKS} />
 <EmptyState
 ...
 <nav className="mx-auto mt-2 flex items-center justify-center gap-3" aria-label="Paginação do blog">
 {pageData.hasPrev ? (
 <Link
 ...
 rel="prev"
 className="inline-flex min-h-[44px] items-center justify-center rounded-pill border border-border px-4 py-2 text-sm font-semibold text-text transition hover:border-brand focus:outline-none focus-visible:ring-2 focus-visible:ring-brand focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--surface)]"
 ...
 Página {pageData.page} de {Math.max(1, Math.ceil(pageData.total / pageData.pageSize))}
 </span>
 {pageData.hasNext ? (
 <Link
 href={`/blog?${new URLSearchParams({
 ...
 key={link.href}
 href={link.href}
 className="group flex flex-col gap-3 rounded-2xl border border-border/60 bg-surface-subtle p-5 transition hover:-translate-y-1 hover:border-brand/70 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--surface)]"
 >
...
function Hero({
 ...
 <form method="get" action="/blog" className="mt-6 flex flex-col gap-3 sm:flex-row sm:items-center">
 ...
 key={link.href}
 href={link.href}
 className="group flex flex-col gap-2 rounded-2xl border border-border/60 bg-surface-subtle p-5 transition hover:-translate-y-1 hover:border-brand/70 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--surface)]"
 >
 <span className="text-xs font-semibold uppercase tracking-[0.3em] text-brand">Leia também</span>
 <h3 className="text-base font-semibold text-text group-hover:text-brand">{link.title}</h3>
 <p className="text-sm text-text-muted">{link.description}</p>
