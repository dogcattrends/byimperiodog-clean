...
export async function GET(){
 ...
 >(
 `*[_type == "category" && defined(slug.current)] | order(_updatedAt desc)[0...2000]{ slug, _updatedAt, _createdAt }`
 );
 ...
 return { loc: `${site}/categorias/${encodeURIComponent(String(slug))}`, lastmod, changefreq: 'weekly', priority: '0.5' };
 })
