...
const EDITORIAL_SNIPPET =
 "Esta política editorial explica como a By Império Dog planeja, revisa e atualiza conteúdos sobre Spitz Alemão Anão Lulu da Pomerânia. Resume critérios de fontes, revisões e correção de erros, garantindo transparência para leitores, imprensa e parceiros. Também descreve como lidar com IA e feedback.";
...
export default function PoliticaEditorialPage() {
 ...
 Spitz Alemão Anão Lulu da Pomerânia. Quando aplicável, citamos profissionais especializados (veterinária, adestramento, genética)
